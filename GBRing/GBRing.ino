...
#define NEOspeed 18         //milliseconds until the next neopixel is in front. (lower is faster)
//#define NEOtail  45         //length of fading tail (must be below pix count)
#define NEOtail  (analogRead(1)/(1024/pix))         //length of fading tail (must be below pix count)
#define NEOcolor 0          //0-1023
#define NEOcolorChange 5   //milliseconds until color change increment (lower is faster)
#define NEOcolorIncrement 2 //color change increment (set it to 0 for no color change)
#define NEOcolorFade 30     //color difference along the tail

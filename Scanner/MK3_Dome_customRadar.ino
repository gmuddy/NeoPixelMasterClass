  ...
  Adafruit_NeoPixel HP = Adafruit_NeoPixel(1, hpPIN, NEO_GRB + NEO_KHZ800); //CN changed RGB to GRB
  Adafruit_NeoPixel EYE = Adafruit_NeoPixel(6, eyePIN, NEO_GRB + NEO_KHZ800); 
